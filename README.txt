...
NOTE: The final check by process 0 is not a required part of the algorithm. It
is simply included as a way of proving that the results are correct.
...
Rationale: The motivation for using a granularity is that it allows
computations on processes 1, 2, and 3 to overlap because they all have data to
